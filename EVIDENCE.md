...
Evidence pin: `3874cdb0bf3b876a1b37fc4b71618343ee0fdf9e`.
The [public commit](https://github.com/matthiasgoergens/tapecheck-evidence/commit/3874cdb0bf3b876a1b37fc4b71618343ee0fdf9e)
...
| `experiments/intercept-overhead/PR2-PROVENANCE-2026-08-21.md` | Compares the measured Tapecheck source path with the revised `splittable_random#2` implementation | The revised PR leaves the measured primitive draw bodies unchanged; this establishes source-path correspondence, not binary identity or a new performance result |
...
- The open `splittable_random` PR now contains the corrected observer contract
  and narrow inactive-cost claim. The benchmark measures Tapecheck's
  corresponding primitive source path, not an exact upstream binary or Jane
  Street hardware configuration.
